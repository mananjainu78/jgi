...
const handleCheckboxChange = (value) => {
  ...
  useEffect(() => {
    ...
    const newChatSocket = new WebSocket('wss://backend-production-197d.up.railway.app/ws/chat');
    newChatSocket.onopen = () => {
      setChatSocket(newChatSocket);
    };
    const initiatesocket = new WebSocket("wss://backend-production-197d.up.railway.app/ws/initiate");
